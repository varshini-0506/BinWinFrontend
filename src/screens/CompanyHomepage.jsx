...
import { Home, User, Trophy, Gamepad, Menu, LogOut, PlayCircle, UserPlus, Flag, HeartHandshake } from "lucide-react-native";
...
export default function HomePage({ navigation }) {
  ...
  Welcome to <Text style={styles.boldText}>BinWin</Text>, your smart solution for <Text style={styles.boldText}>sustainable recycling</Text>!  
  Locate nearby users, schedule pickups, and efficiently collect waste  
  to drive a greener future. 🌱♻️
</Text>
      </View>
      ...
      <View style={styles.bottomNavBar}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => navigation.navigate("CompanyHomepage")}>
